...
class AdminAktivasiKartu extends Model
{
    use HasFactory;
    ...
    protected $fillable = [
        'id_kartu', 'id_ujian', 'id_siswa', 'status_aktivasi', 'tgl_download_kartu'
    ];

    // Relasi ke tabel kartu_ujian
    public function kartuUjian()
    {
        return $this->belongsTo(AdminKartuUjian::class, 'id_kartu');
    }
