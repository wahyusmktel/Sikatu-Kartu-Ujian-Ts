...
@section('breadcrumbs')
    ...
    <li class="nav-item">
        <a href="/admin/generated_cbt">Generated CBT User</a>
    </li>
@endsection
                    ...
                    <div class="card-header">
                        <div class="pull-left">
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#generateModal">
                               <i class="fas fa-user-plus"></i> Generated User
                            </button>
                            <a href="{{ route('admin.export_cbt_csv') }}" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> Export ke CSV</a>
                            <!-- Modal -->
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin.generated_cbt_post') }}" method="POST" onsubmit="return confirmUpdate();">
                                                @csrf
                        ...
                        <div class="pull-right">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="collapse" id="search-nav">
                                    <form class="navbar-form nav-search mr-md-3" action="{{ route('admin.generated_cbt') }}" method="GET">
