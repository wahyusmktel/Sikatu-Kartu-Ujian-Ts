			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-danger">
						...
						<li class="nav-item {{ Request::is('admin/siswa','admin/ujian', 'admin/rombel') ? 'active submenu' : '' }}">
							<a data-toggle="collapse" href="#masterdata" class="collapsed" aria-expanded="false">
								<i class="fas fa-users"></i>
								<p>Master Data</p>
								<span class="caret"></span>
							</a>
							<div class="collapse {{ Request::is('admin/siswa','admin/ujian', 'admin/rombel') ? 'show' : '' }}" id="masterdata">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="/admin/rombel/" class="{{ Request::is('admin/rombel') ? 'active' : '' }}">
											<span class="sub-item">Data Rombel</span>
										</a>
									</li>
									<li>
										<a href="/admin/ujian/" class="{{ Request::is('admin/ujian') ? 'active' : '' }}">
											<span class="sub-item">Data Ujian</span>
										</a>
									</li>
								</ul>
							</div>
						...
						<li class="nav-item {{ Request::is('admin/generated_kartu','admin/aktivasi_kartu', 'admin/generated_cbt', 'admin/generated_cbt_susulan', 'admin/mapel_cbt') ? 'active submenu' : '' }}">
							...
							<div class="collapse {{ Request::is('admin/generated_kartu','admin/aktivasi_kartu', 'admin/generated_cbt', 'admin/generated_cbt_susulan', 'admin/mapel_cbt') ? 'show' : '' }}" id="ujian">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="/admin/generated_cbt_susulan/" class="{{ Request::is('admin/generated_cbt_susulan') ? 'active' : '' }}">
								...
								<li>
									<div class="user-box">
										...
										<div class="u-text">
											...
											<a class="btn btn-xs btn-secondary btn-sm" href="/admin/logout">Logout</a>
										</div>
									</div>
								</li>
								{{-- <li>
